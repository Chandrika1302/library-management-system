...
<body class="bg-gradient-to-l from-cyan-500 to-blue-500">
    ...
    <h2
        class='text-9xl text-center py-44 font-extrabold text-transparent bg-clip-text bg-gradient-to-b via-slate-700 to-slate-800'>
        Welcome to Online Library Management System</h2>
